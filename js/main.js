...
class Page {
	constructor () {
		this.main_page = `<div class="row margin-top-15">
							...
							<div class="col-2"></div>
							<div class="col-4">
								<button type="button" style="border-radius: 30px; background-color: #636EC2; border-color: #636EC2; font-size: 3rem; width: inherit; min-height: 18vh;" class="btn btn-primary"><a id="results_link" href="second_project2.html">RESULTS</a></button>
							</div>
							<div class="col-1"></div>
						</div>`;
